...
//        btn_scan_qr.setOnClickListener(MenuActivity1.this);
//
//        btn_machine_near = findViewById(R.id.btn_machine_near);
//        btn_machine_near.setOnClickListener(MenuActivity1.this);
//
//        btn_my_drinks = findViewById(R.id.btn_my_drinks);
//        btn_my_drinks.setOnClickListener(MenuActivity1.this);
//
//        btn_price_list = findViewById(R.id.btn_price_list);
//        btn_price_list.setOnClickListener(MenuActivity1.this);
//
//        btn_options = findViewById(R.id.btn_options);
//        btn_options.setOnClickListener(MenuActivity1.this);
//
//    }
//
//    @Override
...
//                startActivity(new Intent(MenuActivity1.this, ScanActivity.class));
//                break;
